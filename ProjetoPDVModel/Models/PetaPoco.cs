...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        public void Insert_lstPedidos<T>(int numdoc, IEnumerable<T> collection)
        {
            try
            {
                OpenSharedConnection();
                using (var cmd = CreateCommand(_sharedConnection, ""))
                {
                    ...
                    string cols = string.Join(", ", (from c in pd.QueryColumns select tableName + "." + _provider.EscapeSqlIdentifier(c)).ToArray());
                    ...
                    foreach (var poco in collection)
                    {
                        ...
                        sql += string.Format("INSERT INTO {0} ({1}) VALUES {2};", tableName, cols, string.Join(", ", "(" + string.Join(",", values.ToArray()) + ")"));
        ...
        public int Update(string sql)
        {
            ...
            //var pd = PocoData.ForType(typeof(T), _defaultMapper);
            return Execute(string.Format("{0}", sql));
        }
        ...
        public int Update(string sql, params object[] args)
        {
            ...
            //var pd = PocoData.ForType(typeof(T), _defaultMapper);
            return Execute(string.Format("{0}", sql), args);
        }
        //----------------------------------------------------------------------------
        //----------------------------------------------------------------------------
